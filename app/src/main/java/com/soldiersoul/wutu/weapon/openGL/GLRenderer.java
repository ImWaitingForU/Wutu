package com.soldiersoul.wutu.weapon.openGL;
...
/**
 * Package com.hc.opengl Created by HuaChao on 2016/8/9.
 */
public class GLRenderer implements GLSurfaceView.Renderer {
	...
	public GLRenderer(Context context) {
		...
		try {
			...
			// models.add(model);
			// }
			Model model = reader.parseBinStlInAssets (context,"paotai.STL");
