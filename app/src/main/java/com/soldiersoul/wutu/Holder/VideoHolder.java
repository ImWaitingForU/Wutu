...
public class VideoHolder extends RecyclerBaseHolder {
    ...
    @BindView (R.id.list_item_container) ImageView fengmian;
    @BindView (R.id.list_item_btn) ImageView btn_start;
    ...
    public void onBind (RecyclerBaseModel model, final int position) {
        ...
        //更换封面占位图
        Picasso.with (context).load (videoModel.getFengmianRes ()).placeholder (R.drawable.ic_video).into (fengmian);
