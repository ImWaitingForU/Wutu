...
public class MilitaryNewsFragment extends Fragment {
    ...
    private void initRvList () {
        ...
        final MilitaryNewsBean bean1 =
                new MilitaryNewsBean ("title1", "www.baidu.com", "2017111", "baidu", "content", "");
        final MilitaryNewsBean bean2 =
                new MilitaryNewsBean ("title2", "www.baidu.com", "2017111", "baidu", "content", "");
        final MilitaryNewsBean bean3 =
                new MilitaryNewsBean ("title3", "www.baidu.com", "2017111", "baidu", "content", "");
        final MilitaryNewsBean bean4 =
                new MilitaryNewsBean ("title4", "www.baidu.com", "2017111", "baidu", "content", "");
        final MilitaryNewsBean bean5 =
                new MilitaryNewsBean ("title5", "www.baidu.com", "2017111", "baidu", "content", "");
        data.add (bean1);
        data.add (bean2);
        data.add (bean3);
        data.add (bean4);
