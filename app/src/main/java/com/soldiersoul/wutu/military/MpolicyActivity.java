...
public class MpolicyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mpolicy);
        initViews();
        //加载新闻列表
        init();
//        initDatas();
    ...
    private void initViews() {
        refreshLayout = (SwipeRefreshLayout) findViewById(R.id.military_mpolicy_refresh);
